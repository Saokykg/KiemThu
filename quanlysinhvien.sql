...
INSERT INTO `hocbong` VALUES (1,'Giỏi',1,200000,6),(2,'Khá',2,150000,6);
...
INSERT INTO `monhoc` VALUES (1,'Cơ Sở Dữ liệu',4,2000000,20,2),(2,'Toán Cao Cấp',3,1500000,20,1.5),(3,'Lập trình Giao Diện',4,2000000,16,2),(4,'Lập Trình Hướng Đối Tượng',4,2000000,20,2),(5,'Mạng Máy Tính',4,2000000,20,2),(6,'Phân Giải Dữ Liệu',3,1500000,20,1.5),(7,'Pháp luật đại cương',3,1500000,30,1.5),(8,'Kiến trúc máy tính',4,1500000,30,2),(9,'Thiết kế Web',4,1500000,25,2),(10,'Cấu trúc dữ liệu và giải thuật',5,2500000,30,2.5),(11,'Hệ điều hành',4,1980000,30,2),(12,'Toán rời rạc',3,1450000,25,1.5),(13,'Phân tích thiết kế hệ thống',4,1560000,30,2),(14,'Đường lối CM của Đảng CSVN',2,980000,40,1),(15,'An toàn hệ thống thông tin',4,2200000,35,2),(16,'Quản trị hệ cơ sở dữ liệu',4,2130000,25,2),(17,'Công nghệ phần mềm',4,3120000,25,2),(18,'Kỹ năng nghề nghiệp',2,1200000,30,1),(19,'Lập trình cơ sở dữ liệu',4,1980000,35,2),(20,'Kiểm thử phần mềm',4,2100000,30,2);
