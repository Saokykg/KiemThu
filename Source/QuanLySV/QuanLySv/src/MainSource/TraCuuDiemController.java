...
public class TraCuuDiemController implements Initializable {
    ...
    @FXML
    private ComboBox<Monhoc> cbMonHoc;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        this.cbMonHoc.setDisable(true);
        
        TableColumn<tbLopHoc, String> monCol = new TableColumn<>("tên lớp");
        ...
        gkCol.setCellValueFactory(new PropertyValueFactory<>("gk"));
        
        TableColumn<tbDiem, String> ckCol = new TableColumn<>("Điểm cuối kì");
        ckCol.setCellValueFactory(new PropertyValueFactory<>("ck"));
    ...
    public void hkchose() throws SQLException{
        this.cbMonHoc.getItems().clear();
        System.out.println(this.cbHocKi.getValue().getId());
        this.cbMonHoc.getItems().addAll(Utils.getMH(this.cbHocKi.getValue().getId()));
        if (this.cbMonHoc.getItems().isEmpty()){
            this.cbMonHoc.setDisable(true);
            ...
            this.cbMonHoc.setDisable(false);
    }
}
